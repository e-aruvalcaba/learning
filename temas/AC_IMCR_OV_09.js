...
lib.ssMetadata = [
		{name:"AC_IMCR_OV_09_atlas_", frames: [[0,0,1206,680],[1208,0,51,45]]}
];
...
(lib._0901 = function() {
	this.spriteSheet = ss["AC_IMCR_OV_09_atlas_"];
	this.gotoAndStop(0);
...
(lib.Tween1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Taxonomía de IMCR", "bold 71px 'Arial'", "#FFFFFF");
	this.text.lineHeight = 81;
	this.text.alpha = 0.99215686;
	this.text.parent = this;
	this.text.setTransform(-347.1,-35.2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-349.1,-37.2,682.8,83.3);
...
(lib.text01 = function(mode,startPosition,loop) {
	...
	// Capa 1
	this.instance = new lib._0901();
	this.instance.parent = this;
	this.instance.setTransform(6,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.text01, new cjs.Rectangle(6,0,1206,680), null);
...
(lib.Sydsfmbol1 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#2BAC00").s().p("Eg92AKUIAA0nMB7tAAAIAAUng");
...
(lib.linia = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#2BAC00").ss(6,1,1,3,true).p("AAAwOMAAAAgd");
...
(lib.cuadro = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#2BAC00").ss(6,1,1,3,true).p("AwOwOMAgdAAAMAAAAgdMggdAAAg");
...
(lib.animaciontitulo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(45).to({_off:false},0).wait(1).to({regX:-7.8,regY:10.3,x:87.8,y:278.8},0).wait(1).to({y:277.6},0).wait(1).to({y:275.1},0).wait(1).to({y:270.8},0).wait(1).to({y:263},0).wait(1).to({y:247.7},0).wait(1).to({y:217.9},0).wait(1).to({y:197.9},0).wait(1).to({y:188.6},0).wait(1).to({y:183.6},0).wait(1).to({y:180.9},0).wait(1).to({y:179.5},0).wait(1).to({regX:0,regY:0,x:95.6,y:168.9},0).wait(33));
...
(lib.MC_pag1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1141,-98);
	this.instance._off = true;
...
p.nominalBounds = new cjs.Rectangle(-170.3,-146.1,1447.2,816);


// stage content:
(lib.AC_IMCR_OV_09 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(507.7,279.5,1447.2,823.2);
// library properties:
lib.properties = {
	width: 1200,
	height: 675,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AC_IMCR_OV_09_atlas_.jpg?1576256947250", id:"AC_IMCR_OV_09_atlas_"}
	],
	preloads: []
};
