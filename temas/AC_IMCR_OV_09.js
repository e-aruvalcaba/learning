...
p.nominalBounds = new cjs.Rectangle(0,0,1500,945);// helper functions:
...
(lib.text01 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-7,-15,0.85,0.85);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.text01, new cjs.Rectangle(-7,-15,1274.7,803.1), null);
...
p.nominalBounds = new cjs.Rectangle(-185.9,-164.1,1529.7,963.7);
...
p.nominalBounds = new cjs.Rectangle(492.1,268.7,1529.7,963.7);
// library properties:
lib.properties = {
	width: 1200,
	height: 675,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits7.png?1574009165153", id:"Mapadebits7"}
	],
	preloads: []
};
