...
lib.ssMetadata = [
		{name:"AC_IMCR_OV_19_atlas_", frames: [[0,0,1206,680],[1208,0,51,45]]}
];
...
(lib._0901 = function() {
	this.spriteSheet = ss["AC_IMCR_OV_19_atlas_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AC_IMCR_OV_19_atlas_.jpg?1576257428682", id:"AC_IMCR_OV_19_atlas_"}
	],
	preloads: []
};
