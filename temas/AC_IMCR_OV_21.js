...
lib.ssMetadata = [
		{name:"AC_IMCR_OV_21_atlas_", frames: [[0,0,1206,680],[1208,0,51,45]]}
];
...
(lib._2101 = function() {
	this.spriteSheet = ss["AC_IMCR_OV_21_atlas_"];
	this.gotoAndStop(0);
...
(lib.text01 = function(mode,startPosition,loop) {
	...
	// Capa 1
	this.instance = new lib._2101();
	this.instance.parent = this;
	this.instance.setTransform(6,1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.text01, new cjs.Rectangle(6,1,1206,680), null);
...
p.nominalBounds = new cjs.Rectangle(-170.3,-144.9,1447.2,816);
...
p.nominalBounds = new cjs.Rectangle(507.7,279.5,1447.2,824.4);
// library properties:
lib.properties = {
	width: 1200,
	height: 675,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AC_IMCR_OV_21_atlas_.jpg?1576257669741", id:"AC_IMCR_OV_21_atlas_"}
	],
	preloads: []
};
