...
p.nominalBounds = new cjs.Rectangle(0,0,809,481);// helper functions:
...
(lib.text01 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,1.507,1.507);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.text01, new cjs.Rectangle(0,0,1219.2,724.9), null);
...
p.nominalBounds = new cjs.Rectangle(-177.5,-146.1,1463.1,869.9);
...
p.nominalBounds = new cjs.Rectangle(500.5,279.5,1463.1,877.1);
// library properties:
lib.properties = {
	width: 1200,
	height: 675,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits5.png?1574011017339", id:"Mapadebits5"}
	],
	preloads: []
};
