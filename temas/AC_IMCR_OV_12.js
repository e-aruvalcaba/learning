...
lib.ssMetadata = [
		{name:"AC_IMCR_OV_12_atlas_", frames: [[0,0,1206,680],[1208,0,51,45]]}
];
...
(lib._1201 = function() {
	this.spriteSheet = ss["AC_IMCR_OV_12_atlas_"];
	this.gotoAndStop(0);
...
(lib.Tween1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Proceso y \nherramientas IMCR", "bold 71px 'Arial'", "#FFFFFF");
	this.text.lineHeight = 77;
	this.text.lineWidth = 765;
	this.text.alpha = 0.99215686;
	this.text.parent = this;
	this.text.setTransform(-347.1,-54.1);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-349.1,-56.1,769.1,245.9);
...
(lib.text01 = function(mode,startPosition,loop) {
	...
	// Capa 1
	this.instance = new lib._1201();
	this.instance.parent = this;
	this.instance.setTransform(4,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.text01, new cjs.Rectangle(4,0,1206,680), null);
...
(lib.Sydsfmbol1 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#E71D46").s().p("Eg92AKUIAA0nMB7tAAAIAAUng");
...
(lib.linia = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E71D46").ss(6,1,1,3,true).p("AAAwOMAAAAgd");
...
(lib.cuadro = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E71D46").ss(6,1,1,3,true).p("AwOwOMAgdAAAMAAAAgdMggdAAAg");
...
(lib.animaciontitulo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(45).to({_off:false},0).wait(1).to({regX:35.4,regY:66.8,x:131,y:397.6},0).wait(1).to({y:395.6},0).wait(1).to({y:391.6},0).wait(1).to({y:384.5},0).wait(1).to({y:372},0).wait(1).to({y:347},0).wait(1).to({y:298.6},0).wait(1).to({y:266.2},0).wait(1).to({y:251},0).wait(1).to({y:242.9},0).wait(1).to({y:238.5},0).wait(1).to({y:236.3},0).wait(1).to({regX:0,regY:0,x:95.6,y:168.9},0).wait(33));
...
(lib.MC_pag1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1149,-98);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).wait(1));

	// Capa 4
	this.instance_1 = new lib.animaciontitulo();
	this.instance_1.parent = this;
	this.instance_1.setTransform(750.5,234,0.8,0.8);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(132,143.3,1.2,1.2,0,0,0,257.9,241.2);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:241.3,scaleX:1,scaleY:1,x:172,y:143.4,alpha:1},14,cjs.Ease.get(1)).wait(27));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-172.7,-146.1,1447.2,816);


// stage content:
(lib.AC_IMCR_OV_12 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(505.3,279.5,1447.2,823.2);
// library properties:
lib.properties = {
	width: 1200,
	height: 675,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AC_IMCR_OV_12_atlas_.jpg?1576257176966", id:"AC_IMCR_OV_12_atlas_"}
	],
	preloads: []
};
