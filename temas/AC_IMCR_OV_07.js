...
lib.ssMetadata = [
		{name:"AC_IMCR_OV_07_atlas_", frames: [[0,0,1206,680],[1208,0,51,45]]}
];
...
(lib._0701 = function() {
	this.spriteSheet = ss["AC_IMCR_OV_07_atlas_"];
	this.gotoAndStop(0);
...
(lib.Tween1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Tipos de eventos", "bold 71px 'Arial'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(-309.8,-37.2,584.2,83.3);
...
(lib.Sydsfmbol1 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#42B2CC").s().p("Eg92AKUIAA0nMB7tAAAIAAUng");
...
(lib.linia = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#42B2CC").ss(6,1,1,3,true).p("AAAwOMAAAAgd");
...
(lib.cuadro = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#42B2CC").ss(6,1,1,3,true).p("AwOwOMAgdAAAMAAAAgdMggdAAAg");
...
(lib.animaciontitulo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(45).to({_off:false},0).wait(1).to({regX:-17.9,regY:10.3,x:77.7,y:278.8},0).wait(1).to({y:277.6},0).wait(1).to({y:275.1},0).wait(1).to({y:270.8},0).wait(1).to({y:263},0).wait(1).to({y:247.7},0).wait(1).to({y:217.9},0).wait(1).to({y:197.9},0).wait(1).to({y:188.6},0).wait(1).to({y:183.6},0).wait(1).to({y:180.9},0).wait(1).to({y:179.5},0).wait(1).to({regX:0,regY:0,x:95.6,y:168.9},0).wait(33));
...
// stage content:
(lib.AC_IMCR_OV_07 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AC_IMCR_OV_07_atlas_.jpg?1576256772275", id:"AC_IMCR_OV_07_atlas_"}
	],
	preloads: []
};
