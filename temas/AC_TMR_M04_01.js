...
(lib.M03_TMR_TABLA = function(mode,startPosition,loop) {
	...
	this.shape_183.graphics.f().s("#FFFFFF").p("AomkQIAAIhIRNAAIAAohgAIlEPIxJAAIAAodIRJAAg");
...
p.nominalBounds = new cjs.Rectangle(-64.5,73.8,132,33.5);
...
(lib.M01 = function(mode,startPosition,loop) {
	...
	this.frame_197 = function() {
		...
		function funcion_inicial() {
			try {
				...
				array = ["temas/AC_TMR_M04_01_SIM/index.html", "temas/AC_TMR_M04_01_PRA/index.html", "temas/AC_TMR_M04_02_SIM/index.html", "temas/AC_TMR_M04_02_PRA/index.html", "temas/AC_TMR_M04_03_SIM/index.html", "temas/AC_TMR_M04_03_PRA/index.html", "temas/AC_TMR_M04_04_SIM/index.html", "temas/AC_TMR_M04_04_PRA/index.html"];
		...
		function iniciar() {
			...
			console.log("la variable termino esta en"+ parent.termino);
			if (parent.termino || parent.backdoor) {
				...
				console.log("no esta terminado");
				for (var i = 2; i <= botones; i++) {
	...
	this.b1.parent = this;
	this.b1.setTransform(74.5,267.2);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/modulo4a.png?1556056959214", id:"modulo4a"}
	],
	preloads: []
};
