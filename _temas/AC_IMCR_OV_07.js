...
p.nominalBounds = new cjs.Rectangle(0,0,705,414);// helper functions:
...
(lib.text01 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,-24,1.717,1.717);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.text01, new cjs.Rectangle(0,-24,1210.8,711), null);
...
p.nominalBounds = new cjs.Rectangle(-177.5,-174.9,1452.9,853.2);
...
p.nominalBounds = new cjs.Rectangle(500.5,257.9,1452.9,853.2);
// library properties:
lib.properties = {
	width: 1200,
	height: 675,
